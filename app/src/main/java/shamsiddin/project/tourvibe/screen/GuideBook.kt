...
fun GuideBook(navController: NavController) {
    ...
    val destinationList = mutableListOf<Destination>(
        ...
        Destination(0, "https://api.society.uz/media/news/BOZ_4642.medium.webp", listOf("", "", ""), "Jarkurgan Minaret", "", 4.8, null, "", "", ""),
        Destination(0, "https://silkroaddestinations.com/wp-content/uploads/2016/12/sam-observatory-ulugbek-srd-860x424.jpg", listOf("", "", ""), "Ulugbek Observatory", "", 4.8, null, "", "", "")
    )
